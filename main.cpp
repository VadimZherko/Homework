...
int main()
{
	...
	cout << "\tЗадание 7 \n\t\tЗаполнить массив случайными числами. Генератор уникальных случайных чисел. Вывод минимального числа \n";
...
void zadanie5()
{
	...
	cout << "Введите первое(Первое меньше) и последнее число(Больше, чем первое) в диапозоне, в котором будет рассчитана сумма всех нечетных чисел:" 
		 << endl;
	cin >> number1 >> number2;
...
void zadanie7()
{
	...
	cout << endl << "Минимальное значение = " << minimal << endl;
}
